            ...
            <ul class="comment__list">
                <li class="comment__item">
                    ...
                    <div class="comment__content">
                        ...
                        <p> From 0 to 100%  I can give you 85%  for the that particular project </p>
                    </div>
                </li>
                <li class="comment__item children">
                    ...
                    <div class="comment__content">
                        ...
                        <p> Very Professional Developer </p>
                    </div>
                </li>
                <li class="comment__item">
                    <div class="comment__thumb">
                    ...
                    <div class="comment__content">
                        ...
                        <p> amazing Software Developer keep pushing !!</p>
                    </div>
                </li>
                <li class="comment__item children">
                    <div class="comment__thumb">
                    ...
                    <div class="comment__content">
                        <div class="comment__avatar__info">
                            <div class="info">
                                ...
                                <span class="date">2 january 2023</span>
                            </div>
                            <a href="#" class="reply"><i class="far fa-reply-all"></i></a>
                        </div>
                        <p>driiipp!!!</p>
