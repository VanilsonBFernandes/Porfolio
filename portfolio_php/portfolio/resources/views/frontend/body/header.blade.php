...
@endphp
   ...
   <header>
    ...
    <nav class="menu__nav">
    <div class="logo">
    <a href="index.html" class="logo__black"><img src="{{ asset('frontend/assets/img/logo/vanilson.jpg') }}" alt=""></a>
    <a href="index.html" class="logo__white"><img src="{{ asset('frontend/assets/img/logo/vanilson.jpg') }}" alt=""></a>
    </div>
