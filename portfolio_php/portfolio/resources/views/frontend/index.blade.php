...
@endsection
    ...
    <h2 class="title">Creating amazing web development experiences</h2>
    </div>
    </div>
    ...
    <a href="services-details.html"><img src="{{ asset('frontend/assets/img/images/mao.jpg') }}" alt=""></a>
    ...
    <div class="services__item">
    <div class="services__thumb">
    <a href="services-details.html"><img src="{{ asset('frontend/assets/img/images/26059.jpg') }}" alt=""></a>
    </div>
    <div class="services__content">
    <div class="services__icon">
    ...
    <div class="services__item">
    <div class="services__thumb">
    <a href="services-details.html"><img src="{{ asset('frontend/assets/img/images/temps-3.jpg') }}" alt=""></a>
    </div>
    <div class="services__content">
    <div class="services__icon">
    ...
    <h3 class="title"><a href="services-details.html">implemmenting</a></h3>
    <p>Strategy is a forward-looking plan for your brand’s behavior. Strategy is a forward-looking plan.</p>
    <ul class="services__list">
    <li>User Research & Testing</li>
    <li>UX Design</li>
    ...
    <div class="services__item">
    <div class="services__thumb">
    <a href="services-details.html"><img src="{{ asset('frontend/assets/img/images/maumau.jpg') }}" alt=""></a>
    </div>
    <div class="services__content">
    <div class="services__icon">
    ...
    <div class="services__item">
    <div class="services__thumb">
    <a href="services-details.html"><img src="{{ asset('frontend/assets/img/images/diz.jpg') }}" alt=""></a>
    </div>
    <div class="services__content">
    <div class="services__icon">
    <img class="light" src="{{ asset('frontend/assets/img/icons/services_light_icon02.png') }}" alt="">
    ...
    <h2 class="title">Different Stages of the Web Development Process </h2>
    </div>
    </div>
    </div>
    ...
    <p>The analysis and information gathering phase of the web development process</p>
    </div>
    ...
    <p>It directly impacts the UI/UX of the website.</p>
    </div>
    ...
    <p>The development & coding phase of the web development process is when the actual code for the website is written.</p>
    </div>
    </div>
    </div>
    <div class="col">
    ...
    <div class="work__process__content">
    <h4 class="title">Testing & review</h4>
    <p>Involves testing it comprehensively to iron out any bugs or errors before it goes live.</p>
    </div>
    </div>
    </div>
    <div class="col">
    ...
    <p>The process of putting the website or application live.</p>
    </div>
    ...
    <p> For ensuring optimum performance and continuous upgrades based on evolving requirements</p>
    </div>
  ...
  @include('frontend.home_all.portfolio')
    ...
    <p>I'm a bit of a digital product junky. Over the years, I've used hundreds of web and mobile apps in different industries and verticals. Eventually, I decided that it would be a fun challenge to try designing and building one.</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="homeContact__content">
                                    ...
                                    <h2 class="mail"><a href="mailto:Info@webmail.com">Vanilson1515@mail.com</a></h2>
                                </div>
                            </div>
                            <div class="col-lg-6">
