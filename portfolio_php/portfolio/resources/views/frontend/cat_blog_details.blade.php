                                ...
                                <div class="widget">
                                    ...
                                    <ul class="sidebar__comment">
                                        <li class="sidebar__comment__item">
                                            <a href="blog-details.html"> Jorge Buguemi</a>
                                            <p>Amazing Developer</p>
                                        </li>
                                        <li class="sidebar__comment__item">
                                            <a href="blog-details.html">Maria Pimenta</a>
                                            <p>projecto a funcionar a 100%. muito obrigado!</p>
                                        </li>
                                        <li class="sidebar__comment__item">
                                            <a href="blog-details.html">Dr. Flavio Pimenta</a>
                                            <p>I TRUSTED YOU AND YOU DID NOT DISAPOINT, THANKS A LOT FERNANDES.</p>
                                        </li>
                                        <li class="sidebar__comment__item">
                                            <a href="blog-details.html">Nelson Patricio</a>
                                            <p>Continue a ser estr super Developer. Insine project, I Really Love it..</p>
                                        </li>
                                    </ul>
                                </div>
                                <div class="widget">
